 <?php
  include 'entete.php';
  if (!empty($_GET['id'])) {
    $article = getCommande(id: $_GET['id']);
  }
  ?>
     ...
     <div class="box">
       <form action=<?= !empty($_GET['id']) ? "../model/modifCommande.php" : "../model/ajoutCommande.php" ?> method="post">
         ...
         <select onchange="setPrix()" name="id_article" id="id_article">
           <?php
            $articles = getArticle();
            if (!empty($articles) && is_array(value: $articles)) {
         ...
         <select name="id_fournisseur" id="id_fournisseur">
           <?php
            ...
            if (!empty($clients) && is_array(value: $clients)) {
     ...
     <div class="box">
       <table class="mtable">
         ...
         <?php
          ...
          if (!empty($vente) && is_array(value: $vente)) {
          ...
          ?>
             <tr>
               ...
               <td><?= $value['prix'] ?></td>
               <td><?= date(format: 'd/m/Y H:i:s', timestamp: strtotime(datetime: $value['date_commande'])) ?></td>
               <td>
